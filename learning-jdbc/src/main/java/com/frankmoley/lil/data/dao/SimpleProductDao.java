  ...
  public UUID createProduct(String name, BigDecimal price, String vendorName) {
    ...
    try {
      ...
      try {
        ...
        DatabaseUtils.handleSqlException("SimpleProductDao.createProduct.rollback", sqle, LOGGER);
      }
      DatabaseUtils.handleSqlException("SimpleProductDao.createProduct", e, LOGGER);
    }
    return returnVal;
  }
